package DesignPatterns.Visitor.Exercice;
...
public class Ex {
    public static void main(String[] args) {
        MultiplicationExpression me = new MultiplicationExpression(new AdditionExpression(new Value(2), new Value(3)), new Value(4));
